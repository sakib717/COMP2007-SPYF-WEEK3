<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsianCup.aspx.cs" Inherits="COMP2007_S2016_Lesson6B.AsianCup" %>
        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover"
                    ID="AsianCupGridView" AutoGenerateColumns="false" DataKeyNames="GameID"
                    OnRowDeleting="AsianCupGridView_RowDeleting" AllowPaging="true" PageSize="3"
                    OnPageIndexChanging="AsianCupGridView_PageIndexChanging" AllowSorting="true"
                    OnSorting="AsianCupGridView_Sorting" PagerStyle-CssClass="pagination-ys">
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Edit" Text="<i class='fa fa-pencil-square-o fa-lg'></i> Edit" 
                            NavigateUrl="~/AsianCupDetails.aspx.cs" ControlStyle-CssClass="btn btn-primary btn-sm" runat="server"
                            DataNavigateUrlFields="GameID" DataNavigateUrlFormatString="AsianCupDetails.aspx?GameID={0}" />
