...
{
    public partial class AsianCupDetails : System.Web.UI.Page
    {
        ...
        protected void GetGame()
        {
            ...
            using (DefaultConnect db = new DefaultConnect())
            {
                ...
                Asia updatedGameList = (from GameList in db.Asias
        ...
        protected void CancelButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/AsianCup.aspx");
        }
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            using (DefaultConnect db = new DefaultConnect())
            {
                ...
                if (Request.QueryString.Count > 0) // our URL has a TodoID in it
                {
                    ...
                    newGameList = (from Asia in db.Asias
                                   where Asia.GameID == GameID
                                   select Asia).FirstOrDefault();
                }
